...
The IMyCompanyMyPythonBindingInterface located in `include/my_company/my_python_binding/IMyCompanyMyPythonBindingInterface.h` is:
- Implemented in `plugins/my_company.my_python_binding/ExamplePybindExtension.cpp`.
- Reflected in `bindings/python/my_company.my_python_binding/ExamplePybindBindings.cpp`.
