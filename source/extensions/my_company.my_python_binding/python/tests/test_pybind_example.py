...
import my_company.my_python_binding


class TestPybindExample(omni.kit.test.AsyncTestCase):
    async def setUp(self):
        # Cache the pybind interface.
        self.bound_interface = my_company.my_python_binding.get_bound_interface()

        # Create and register a bound object.
        self.bound_object = my_company.my_python_binding.MyCompanyMyPythonBindingObject("test_bound_object")
